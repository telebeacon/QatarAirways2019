...
<img src="imageViewadd.php?image_id=<?php echo $row["imageId"]; ?>" /><br/>

<img src="imageViewadd1.php?image_id=<?php echo $row["imageId"]; ?>" /><br/>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo $row["age"]; ?>" id="age" name="age" placeholder="Enter Latest key">
  </div>

<div class="form-group">
    <label for="sex">Sex</label>
    <input type="text" class="form-control" value="<?php echo $row["sex"]; ?>" id="sex" name="sex" placeholder="Enter Latest key">
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo $row["departure"]; ?>" id="departure" name="departure" placeholder="Enter Latest key">
  </div>

<div class="form-group">
    <label for="arrival">Arrival</label>
    <input type="text" class="form-control" value="<?php echo $row["arrival"]; ?>" id="arrival" name="arrival" placeholder="Enter Latest key">
  </div>
<div class="form-group">
    <label for="baggages">Linked Baggages No</label>
    <input type="text" class="form-control" value="<?php echo $row["baggages"]; ?>" id="baggages" name="baggages" placeholder="Enter Latest key">
  </div>

<div class="form-group">
    <label for="latest">Latest</label>
    <input type="text" class="form-control" value="<?php echo $row["latest"]; ?>" id="latest" name="latest" placeholder="Enter Latest key">
  </div>

<div class="form-group">
    <label for="major">Major</label>
    <input type="text" class="form-control" value="<?php echo $row["major"]; ?>" id="major" name="major" placeholder="Enter Major ID">
  </div>
<div class="form-group">
    <label for="minor">Minor</label>
    <input type="text" class="form-control" value="<?php echo $row["minor"]; ?>" id="minor" name="minor" placeholder="Enter Minor key">
  </div>

<a href="?do=delete&imageId=<?php echo $row["imageId"]; ?>" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure?\')">Delete</a></td>
